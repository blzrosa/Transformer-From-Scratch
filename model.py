...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        self.w_o = nn.Linear(d_model, d_model) # h * d_v; d_v = d_k
        self.dropout = nn.Dropout(dropout)
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, 
    ...
    for _ in range(N):
        ...
        decoder_cross_atention_block = MultiHeadAttentionBlock(d_model, h, dropout)
        feed_forward_block = FeedForwardBlock(d_model, d_ff, dropout)
        decoder_block = DecoderBlock(decoder_self_attention_block, decoder_cross_atention_block, feed_forward_block, dropout)
